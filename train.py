...
if __name__ == "__main__":
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    pretrained_model_dir = os.path.join(out_dir, 'trained_model-v2.pt')
    ...
    fine_tune_model(model, fine_tune_dataloader, optimizer, scheduler, loss_function, vocab, fine_tune_epochs=10, out_dir=out_dir)
